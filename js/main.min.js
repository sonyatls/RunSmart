...
"use strict";$(document).ready(function(){function t(t){$(t).each(function(o){$(this).on("click",function(t){t.preventDefault(),$(".catalog-item__content").eq(o).toggleClass("catalog-item__content_active"),$(".catalog-item__box").eq(o).toggleClass("catalog-item__box_active")})})}function o(t){$(t).validate({rules:{name:"required",phone:"required",email:{required:!0,email:!0}},messages:{name:"Пожалуйста, введите своё имя",phone:"Пожалуйста, введите своё номер телефона",email:{required:"Пожалуйста, введите свою почту",email:"Неправильно введён адрес почты"}}})}$(".carousel__inner").slick({speed:1200,adaptiveHeight:!0,arrows:!0,prevArrow:'<button type="button" class="slick-prev"><img src="../img/carousel/chevron-left-solid.png"></button>',nextArrow:'<button type="button" class="slick-next"><img src="../img/carousel/chevron-right-solid.png"></button>',responsive:[{breakpoint:992,settings:{dots:!0,arrows:!1}}]}),$("ul.catalog__tabs").on("click","li:not(.catalog__tab_active)",function(){$(this).addClass("catalog__tab_active").siblings().removeClass("catalog__tab_active").closest("div.container").find("div.catalog__content").removeClass("catalog__content_active").eq($(this).index()).addClass("catalog__content_active")}),t(".catalog-item__link"),t(".catalog-item__back"),$("[data-modal=consultation]").on("click",function(){$(".overlay, #consultation").fadeIn("slow"),$(".modal__close").on("click",function(){$(".overlay, #consultation, #thanks, #order").fadeOut("slow")}),$(".button_catalog").each(function(t){$(this).on("click",function(){$("#order .modal__descr").text($(".catalog-item__subtitle").eq(t).text()),$(".overlay, #order").fadeIn("slow")})})}),o("#consultation-form"),o("#consultation form"),o("#order form"),$(window).scroll(function(){1600<$(this).scrollTop()?$(".pageup").fadeIn():$(".pageup").fadeOut()}),$("a[href^='#']").on("click",function(){var t=$(this).attr("href");return $("html, body").animate({scrollTop:$(t).offset().top}),!1})});
